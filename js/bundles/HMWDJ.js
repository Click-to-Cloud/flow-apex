...
var HMWDJ = function (_Component) {
  _inherits(HMWDJ, _Component);

  function HMWDJ() {
    _classCallCheck(this, HMWDJ);

    return _possibleConstructorReturn(this, (HMWDJ.__proto__ || Object.getPrototypeOf(HMWDJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HMWDJ, _step_10Soy2.default);

exports.default = HMWDJ;
...
exports.templates = exports.HMWDJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HMWDJ.
   * @public
   */

  goog.module('HMWDJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HMWDJ.render';
  }
...
_metalSoy2.default.register(HMWDJ, templates);
exports.HMWDJ = HMWDJ;
