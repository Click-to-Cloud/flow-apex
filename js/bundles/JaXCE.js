...
var JaXCE = function (_Component) {
  _inherits(JaXCE, _Component);

  function JaXCE() {
    _classCallCheck(this, JaXCE);

    return _possibleConstructorReturn(this, (JaXCE.__proto__ || Object.getPrototypeOf(JaXCE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JaXCE, _step_9Soy2.default);

exports.default = JaXCE;
...
exports.templates = exports.JaXCE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JaXCE.
   * @public
   */

  goog.module('JaXCE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JaXCE.render';
  }
...
_metalSoy2.default.register(JaXCE, templates);
exports.JaXCE = JaXCE;
