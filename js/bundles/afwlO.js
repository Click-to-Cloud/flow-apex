...
var afwlO = function (_Component) {
  _inherits(afwlO, _Component);

  function afwlO() {
    _classCallCheck(this, afwlO);

    return _possibleConstructorReturn(this, (afwlO.__proto__ || Object.getPrototypeOf(afwlO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(afwlO, _step_9Soy2.default);

exports.default = afwlO;
...
exports.templates = exports.afwlO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace afwlO.
   * @public
   */

  goog.module('afwlO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'afwlO.render';
  }
...
_metalSoy2.default.register(afwlO, templates);
exports.afwlO = afwlO;
