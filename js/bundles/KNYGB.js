...
var KNYGB = function (_Component) {
  _inherits(KNYGB, _Component);

  function KNYGB() {
    _classCallCheck(this, KNYGB);

    return _possibleConstructorReturn(this, (KNYGB.__proto__ || Object.getPrototypeOf(KNYGB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KNYGB, _blockSoy2.default);

exports.default = KNYGB;
...
exports.templates = exports.KNYGB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KNYGB.
   * @public
   */

  goog.module('KNYGB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KNYGB.render';
  }
...
_metalSoy2.default.register(KNYGB, templates);
exports.KNYGB = KNYGB;
