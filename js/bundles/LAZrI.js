...
var LAZrI = function (_Component) {
  _inherits(LAZrI, _Component);

  function LAZrI() {
    _classCallCheck(this, LAZrI);

    return _possibleConstructorReturn(this, (LAZrI.__proto__ || Object.getPrototypeOf(LAZrI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LAZrI, _step_8Soy2.default);

exports.default = LAZrI;
...
exports.templates = exports.LAZrI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace LAZrI.
   * @public
   */

  goog.module('LAZrI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'LAZrI.render';
  }
...
_metalSoy2.default.register(LAZrI, templates);
exports.LAZrI = LAZrI;
