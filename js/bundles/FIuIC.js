...
var FIuIC = function (_Component) {
  _inherits(FIuIC, _Component);

  function FIuIC() {
    _classCallCheck(this, FIuIC);

    return _possibleConstructorReturn(this, (FIuIC.__proto__ || Object.getPrototypeOf(FIuIC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FIuIC, _indexSoy2.default);

exports.default = FIuIC;
...
exports.templates = exports.FIuIC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FIuIC.
   * @public
   */

  goog.module('FIuIC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FIuIC.render';
  }
...
_metalSoy2.default.register(FIuIC, templates);
exports.FIuIC = FIuIC;
