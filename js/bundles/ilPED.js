...
var ilPED = function (_Component) {
  _inherits(ilPED, _Component);

  function ilPED() {
    _classCallCheck(this, ilPED);

    return _possibleConstructorReturn(this, (ilPED.__proto__ || Object.getPrototypeOf(ilPED)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ilPED, _step_14Soy2.default);

exports.default = ilPED;
...
exports.templates = exports.ilPED = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ilPED.
   * @public
   */

  goog.module('ilPED.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ilPED.render';
  }
...
_metalSoy2.default.register(ilPED, templates);
exports.ilPED = ilPED;
