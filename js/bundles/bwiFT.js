...
var bwiFT = function (_Component) {
  _inherits(bwiFT, _Component);

  function bwiFT() {
    _classCallCheck(this, bwiFT);

    return _possibleConstructorReturn(this, (bwiFT.__proto__ || Object.getPrototypeOf(bwiFT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bwiFT, _step_2Soy2.default);

exports.default = bwiFT;
...
exports.templates = exports.bwiFT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bwiFT.
   * @public
   */

  goog.module('bwiFT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bwiFT.render';
  }
...
_metalSoy2.default.register(bwiFT, templates);
exports.bwiFT = bwiFT;
