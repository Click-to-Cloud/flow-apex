...
var Muiwu = function (_Component) {
  _inherits(Muiwu, _Component);

  function Muiwu() {
    _classCallCheck(this, Muiwu);

    return _possibleConstructorReturn(this, (Muiwu.__proto__ || Object.getPrototypeOf(Muiwu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Muiwu, _step_8Soy2.default);

exports.default = Muiwu;
...
exports.templates = exports.Muiwu = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Muiwu.
   * @public
   */

  goog.module('Muiwu.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Muiwu.render';
  }
...
_metalSoy2.default.register(Muiwu, templates);
exports.Muiwu = Muiwu;
