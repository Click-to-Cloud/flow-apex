...
var ShGip = function (_Component) {
  _inherits(ShGip, _Component);

  function ShGip() {
    _classCallCheck(this, ShGip);

    return _possibleConstructorReturn(this, (ShGip.__proto__ || Object.getPrototypeOf(ShGip)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ShGip, _step_11Soy2.default);

exports.default = ShGip;
...
exports.templates = exports.ShGip = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ShGip.
   * @public
   */

  goog.module('ShGip.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ShGip.render';
  }
...
_metalSoy2.default.register(ShGip, templates);
exports.ShGip = ShGip;
