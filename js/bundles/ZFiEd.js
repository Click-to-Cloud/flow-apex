...
var ZFiEd = function (_Component) {
  _inherits(ZFiEd, _Component);

  function ZFiEd() {
    _classCallCheck(this, ZFiEd);

    return _possibleConstructorReturn(this, (ZFiEd.__proto__ || Object.getPrototypeOf(ZFiEd)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZFiEd, _indexSoy2.default);

exports.default = ZFiEd;
...
exports.templates = exports.ZFiEd = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZFiEd.
   * @public
   */

  goog.module('ZFiEd.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZFiEd.render';
  }
...
_metalSoy2.default.register(ZFiEd, templates);
exports.ZFiEd = ZFiEd;
