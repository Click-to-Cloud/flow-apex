...
var nKJtg = function (_Component) {
  _inherits(nKJtg, _Component);

  function nKJtg() {
    _classCallCheck(this, nKJtg);

    return _possibleConstructorReturn(this, (nKJtg.__proto__ || Object.getPrototypeOf(nKJtg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nKJtg, _step_11Soy2.default);

exports.default = nKJtg;
...
exports.templates = exports.nKJtg = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nKJtg.
   * @public
   */

  goog.module('nKJtg.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nKJtg.render';
  }
...
_metalSoy2.default.register(nKJtg, templates);
exports.nKJtg = nKJtg;
