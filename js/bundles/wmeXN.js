...
var wmeXN = function (_Component) {
  _inherits(wmeXN, _Component);

  function wmeXN() {
    _classCallCheck(this, wmeXN);

    return _possibleConstructorReturn(this, (wmeXN.__proto__ || Object.getPrototypeOf(wmeXN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wmeXN, _indexSoy2.default);

exports.default = wmeXN;
...
exports.templates = exports.wmeXN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wmeXN.
   * @public
   */

  goog.module('wmeXN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wmeXN.render';
  }
...
_metalSoy2.default.register(wmeXN, templates);
exports.wmeXN = wmeXN;
