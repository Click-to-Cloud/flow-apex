...
var QnsKV = function (_Component) {
  _inherits(QnsKV, _Component);

  function QnsKV() {
    _classCallCheck(this, QnsKV);

    return _possibleConstructorReturn(this, (QnsKV.__proto__ || Object.getPrototypeOf(QnsKV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QnsKV, _step_1Soy2.default);

exports.default = QnsKV;
...
exports.templates = exports.QnsKV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QnsKV.
   * @public
   */

  goog.module('QnsKV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QnsKV.render';
  }
...
_metalSoy2.default.register(QnsKV, templates);
exports.QnsKV = QnsKV;
