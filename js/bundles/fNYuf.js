...
var fNYuf = function (_Component) {
  _inherits(fNYuf, _Component);

  function fNYuf() {
    _classCallCheck(this, fNYuf);

    return _possibleConstructorReturn(this, (fNYuf.__proto__ || Object.getPrototypeOf(fNYuf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fNYuf, _functionSoy2.default);

exports.default = fNYuf;
...
exports.templates = exports.fNYuf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fNYuf.
   * @public
   */

  goog.module('fNYuf.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param518 = function param518() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fNYuf.render';
  }
...
_metalSoy2.default.register(fNYuf, templates);
exports.fNYuf = fNYuf;
