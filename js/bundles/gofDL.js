...
var gofDL = function (_Component) {
  _inherits(gofDL, _Component);

  function gofDL() {
    _classCallCheck(this, gofDL);

    return _possibleConstructorReturn(this, (gofDL.__proto__ || Object.getPrototypeOf(gofDL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gofDL, _functionSoy2.default);

exports.default = gofDL;
...
exports.templates = exports.gofDL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gofDL.
   * @public
   */

  goog.module('gofDL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gofDL.render';
  }
...
_metalSoy2.default.register(gofDL, templates);
exports.gofDL = gofDL;
