...
var Hyokl = function (_Component) {
  _inherits(Hyokl, _Component);

  function Hyokl() {
    _classCallCheck(this, Hyokl);

    return _possibleConstructorReturn(this, (Hyokl.__proto__ || Object.getPrototypeOf(Hyokl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Hyokl, _step_6Soy2.default);

exports.default = Hyokl;
...
exports.templates = exports.Hyokl = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Hyokl.
   * @public
   */

  goog.module('Hyokl.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Hyokl.render';
  }
...
_metalSoy2.default.register(Hyokl, templates);
exports.Hyokl = Hyokl;
