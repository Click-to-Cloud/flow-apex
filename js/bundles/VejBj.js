...
var VejBj = function (_Component) {
  _inherits(VejBj, _Component);

  function VejBj() {
    _classCallCheck(this, VejBj);

    return _possibleConstructorReturn(this, (VejBj.__proto__ || Object.getPrototypeOf(VejBj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VejBj, _step_3Soy2.default);

exports.default = VejBj;
...
exports.templates = exports.VejBj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VejBj.
   * @public
   */

  goog.module('VejBj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VejBj.render';
  }
...
_metalSoy2.default.register(VejBj, templates);
exports.VejBj = VejBj;
