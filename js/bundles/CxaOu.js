...
var CxaOu = function (_Component) {
  _inherits(CxaOu, _Component);

  function CxaOu() {
    _classCallCheck(this, CxaOu);

    return _possibleConstructorReturn(this, (CxaOu.__proto__ || Object.getPrototypeOf(CxaOu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CxaOu, _step_3Soy2.default);

exports.default = CxaOu;
...
exports.templates = exports.CxaOu = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CxaOu.
   * @public
   */

  goog.module('CxaOu.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CxaOu.render';
  }
...
_metalSoy2.default.register(CxaOu, templates);
exports.CxaOu = CxaOu;
