...
var DeOOD = function (_Component) {
  _inherits(DeOOD, _Component);

  function DeOOD() {
    _classCallCheck(this, DeOOD);

    return _possibleConstructorReturn(this, (DeOOD.__proto__ || Object.getPrototypeOf(DeOOD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DeOOD, _step_14Soy2.default);

exports.default = DeOOD;
...
exports.templates = exports.DeOOD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DeOOD.
   * @public
   */

  goog.module('DeOOD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DeOOD.render';
  }
...
_metalSoy2.default.register(DeOOD, templates);
exports.DeOOD = DeOOD;
