...
var LrpKU = function (_Component) {
  _inherits(LrpKU, _Component);

  function LrpKU() {
    _classCallCheck(this, LrpKU);

    return _possibleConstructorReturn(this, (LrpKU.__proto__ || Object.getPrototypeOf(LrpKU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LrpKU, _step_7Soy2.default);

exports.default = LrpKU;
...
exports.templates = exports.LrpKU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace LrpKU.
   * @public
   */

  goog.module('LrpKU.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'LrpKU.render';
  }
...
_metalSoy2.default.register(LrpKU, templates);
exports.LrpKU = LrpKU;
