...
var bCBMQ = function (_Component) {
  _inherits(bCBMQ, _Component);

  function bCBMQ() {
    _classCallCheck(this, bCBMQ);

    return _possibleConstructorReturn(this, (bCBMQ.__proto__ || Object.getPrototypeOf(bCBMQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bCBMQ, _blockSoy2.default);

exports.default = bCBMQ;
...
exports.templates = exports.bCBMQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bCBMQ.
   * @public
   */

  goog.module('bCBMQ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bCBMQ.render';
  }
...
_metalSoy2.default.register(bCBMQ, templates);
exports.bCBMQ = bCBMQ;
