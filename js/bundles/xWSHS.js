...
var xWSHS = function (_Component) {
  _inherits(xWSHS, _Component);

  function xWSHS() {
    _classCallCheck(this, xWSHS);

    return _possibleConstructorReturn(this, (xWSHS.__proto__ || Object.getPrototypeOf(xWSHS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(xWSHS, _staticSoy2.default);

exports.default = xWSHS;
...
exports.templates = exports.xWSHS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace xWSHS.
   * @public
   */

  goog.module('xWSHS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'xWSHS.render';
  }
...
_metalSoy2.default.register(xWSHS, templates);
exports.xWSHS = xWSHS;
