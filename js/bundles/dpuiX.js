...
var dpuiX = function (_Component) {
  _inherits(dpuiX, _Component);

  function dpuiX() {
    _classCallCheck(this, dpuiX);

    return _possibleConstructorReturn(this, (dpuiX.__proto__ || Object.getPrototypeOf(dpuiX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dpuiX, _step_7Soy2.default);

exports.default = dpuiX;
...
exports.templates = exports.dpuiX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace dpuiX.
   * @public
   */

  goog.module('dpuiX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'dpuiX.render';
  }
...
_metalSoy2.default.register(dpuiX, templates);
exports.dpuiX = dpuiX;
