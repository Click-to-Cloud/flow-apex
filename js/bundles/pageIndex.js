...
goog.loadModule(function (exports) {
  ...
  function $header(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Get Started');
    ie_close('a');
    ie_open('a', null, null, 'href', 'https://github.com/Click-to-Cloud/Flow.apex/', 'class', 'btn btn-success btn-sm');
    itext('GitHub');
    ie_close('a');
  ...
  function $why(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Flow.apex is created to simplify the creation of a Function. It simulates the procedural invocation of Functions, and weave them to build a larger and more complicated Function. Flow.apex acts as a bridge between the small Funcs and big custom Funcs that you create by subclassing Func.');
    ie_close('p');
    ie_close('div');
    ie_close('div');
    ie_close('div');
  ...
  function $features(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Flow.apex offers a fluent API to build a custom Func without subclassing Func.');
    ie_close('p');
    ie_close('section');
    ie_open('section', null, null, 'class', 'feature col-md-4');
    ie_open('h3', null, null, 'class', 'feature-title');
    itext('Abundant Structures');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('Flow.apex has adequate block structures to help weaving your Funcs.');
    ie_close('p');
    ie_close('section');
    ie_open('section', null, null, 'class', 'feature col-md-4');
    ie_open('h3', null, null, 'class', 'feature-title');
    itext('FlowScript Support');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('Flow.apex enables a mechanism to support embedded scripting in Flows.');
    ie_close('p');
    ie_close('section');
    ie_close('div');
    ie_close('div');
  ...
  function $how(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_open('div', null, null, 'class', 'col-md-12 col-md-offset-2');
    ie_open('h3', null, null, 'class', 'about-title');
    itext('One Step From R.apex');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'about-description');
    itext('It is the cousin of R.apex, only more powerful.');
    ie_close('p');
    ie_close('div');
    ie_close('div');
    ie_close('div');
  ...
  function $highlights(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Flow.apex uses procedral structures to build Funcs in the form of Flows.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-1');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/flow-apex/images/highlight_1.png', 'alt', 'Build Funcs', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_open('section', null, null, 'class', 'highlight row');
    ...
    ie_close('h4');
    ie_open('p', null, null, 'class', 'highlight-description');
    itext('Flow.apex not only creates Funcs, but also creates executable blocks of code.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-2 col-md-pull-6');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/flow-apex/images/highlight_2.png', 'alt', 'Code Blocks', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_open('section', null, null, 'class', 'highlight row');
    ...
    ie_close('h4');
    ie_open('p', null, null, 'class', 'highlight-description');
    itext('Flow.apex includes a script that naturally integrates with R.apex and all of your Funcs.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-1');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/flow-apex/images/highlight_3.png', 'alt', 'FlowScript', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_close('div');
