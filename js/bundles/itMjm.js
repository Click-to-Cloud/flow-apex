...
var itMjm = function (_Component) {
  _inherits(itMjm, _Component);

  function itMjm() {
    _classCallCheck(this, itMjm);

    return _possibleConstructorReturn(this, (itMjm.__proto__ || Object.getPrototypeOf(itMjm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(itMjm, _staticSoy2.default);

exports.default = itMjm;
...
exports.templates = exports.itMjm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace itMjm.
   * @public
   */

  goog.module('itMjm.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param586 = function param586() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'itMjm.render';
  }
...
_metalSoy2.default.register(itMjm, templates);
exports.itMjm = itMjm;
