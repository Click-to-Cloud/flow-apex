...
var ZqRKw = function (_Component) {
  _inherits(ZqRKw, _Component);

  function ZqRKw() {
    _classCallCheck(this, ZqRKw);

    return _possibleConstructorReturn(this, (ZqRKw.__proto__ || Object.getPrototypeOf(ZqRKw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZqRKw, _step_6Soy2.default);

exports.default = ZqRKw;
...
exports.templates = exports.ZqRKw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZqRKw.
   * @public
   */

  goog.module('ZqRKw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZqRKw.render';
  }
...
_metalSoy2.default.register(ZqRKw, templates);
exports.ZqRKw = ZqRKw;
