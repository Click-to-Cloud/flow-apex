...
var bDOTP = function (_Component) {
  _inherits(bDOTP, _Component);

  function bDOTP() {
    _classCallCheck(this, bDOTP);

    return _possibleConstructorReturn(this, (bDOTP.__proto__ || Object.getPrototypeOf(bDOTP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bDOTP, _indexSoy2.default);

exports.default = bDOTP;
...
exports.templates = exports.bDOTP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bDOTP.
   * @public
   */

  goog.module('bDOTP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bDOTP.render';
  }
...
_metalSoy2.default.register(bDOTP, templates);
exports.bDOTP = bDOTP;
