...
var dEmDC = function (_Component) {
  _inherits(dEmDC, _Component);

  function dEmDC() {
    _classCallCheck(this, dEmDC);

    return _possibleConstructorReturn(this, (dEmDC.__proto__ || Object.getPrototypeOf(dEmDC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dEmDC, _step_10Soy2.default);

exports.default = dEmDC;
...
exports.templates = exports.dEmDC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace dEmDC.
   * @public
   */

  goog.module('dEmDC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'dEmDC.render';
  }
...
_metalSoy2.default.register(dEmDC, templates);
exports.dEmDC = dEmDC;
