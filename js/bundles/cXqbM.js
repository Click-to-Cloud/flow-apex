...
var cXqbM = function (_Component) {
  _inherits(cXqbM, _Component);

  function cXqbM() {
    _classCallCheck(this, cXqbM);

    return _possibleConstructorReturn(this, (cXqbM.__proto__ || Object.getPrototypeOf(cXqbM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(cXqbM, _step_2Soy2.default);

exports.default = cXqbM;
...
exports.templates = exports.cXqbM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace cXqbM.
   * @public
   */

  goog.module('cXqbM.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'cXqbM.render';
  }
...
_metalSoy2.default.register(cXqbM, templates);
exports.cXqbM = cXqbM;
